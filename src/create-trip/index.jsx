...
function CreateTrip() {
  ...
  const OnGenerateTrip = async () => {
    ...
    // check it the user already logged in
...
import axios from "axios"
import { doc, setDoc } from "firebase/firestore";
import { db } from "@/service/firebaseConfig";  // Ensure this path points to your Firebase configuration file
        ...
        <div>
            ...
            <div className="grid grid-cols-3 gap-5 mt-5 mb-5">
              {SelectBudgetOptions.map((item,index)=>(
                ...
                // formData?.budget==item.title& is for having shadow after selecting any option.
